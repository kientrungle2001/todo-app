...
export const AdminGameTopicSettings: TableGridSettings = {
    title: gridTitle,
    table: gridTable,
    joins: gridJoins,
    fields: gridFields,
    ...
    deleteSelectedsLabel: "Xóa Game Topic đã chọn",
    updateLabel: "Cập nhật Game Topic",
    treeMode: true,
}