...
const gridJoins: DataGridTableJoin[] = [{
    ...
    table: "courses", alias: "c", type: "left", condition: "t.courseId = c.id"
}];
const gridSearchFields: string[] = ["id", "username", "bank", "u.name", "u.email", "u.phone", "u.address", "c.name"];
const gridFields: string[] = ["id", "username", "u.name as name", "u.phone as phone", "c.name as courseName", "amount", "paymentType", "bank", "paymentDate", "expiredDate", "status", "paymentStatus"];
...
const gridColumns: DataGridColumn[] = [
    ...
    { index: "courseName", label: "Khóa học" },
    {
        index: "paymentType",
...
const gridAddFields: DataGridEditField[] = [
    { index: "username", label: "Tên đăng nhập", type: DataGridEditFieldType.TEXT, size: 6 },
    {
        ...
        table: "courses", valueField: "id", labelField: "name"
    },
    { index: "amount", label: "Số tiền", type: DataGridEditFieldType.TEXT, size: 6 },
    { index: "paymentDate", label: "Ngày thanh toán", type: DataGridEditFieldType.DATE, size: 6 },
    { index: "expiredDate", label: "Ngày hết hạn", type: DataGridEditFieldType.DATE, size: 6 },
    {
...
export const PmtvAdminHistoryPaymentSettings: TableGridSettings = {
    title: gridTitle,
    table: gridTable,
    joins: gridJoins,
    fields: gridFields,
