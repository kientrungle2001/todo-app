...
interface CategoryDetailQuestionProps {
    hostConfig?: any;
    item: any;
    question: any;
    index: number;
...
export const CategoryDetailQuestion: React.FC<CategoryDetailQuestionProps> = ({ hostConfig, question, index, item }): React.ReactElement => {
